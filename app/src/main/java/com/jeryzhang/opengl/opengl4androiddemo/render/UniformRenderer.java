...
import com.jeryzhang.opengl.opengl4androiddemo.R;
import com.jeryzhang.opengl.opengl4androiddemo.util.ResReadUtils;
...
public class UniformRenderer implements GLSurfaceView.Renderer {
    ...
    public UniformRenderer(Context context) {
        mContext = context;
    }
